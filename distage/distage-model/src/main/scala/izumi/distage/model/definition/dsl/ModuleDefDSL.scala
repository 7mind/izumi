...
/**
  ...
  * @see [[ModuleDefDSL]]
  */
trait ModuleDefDSL extends AbstractBindingDefDSL[ModuleDefDSL.BindDSL, ModuleDefDSL.MultipleDSL, ModuleDefDSL.SetDSL] with IncludesDSL with TagsDSL {
  this: ModuleBase =>
...
object ModuleDefDSL {
  ...
  trait BindDSLBase[T, AfterBind] {
    ...
    )(implicit adapt: ProviderMagnet[R0] => ProviderMagnet[R with DIResourceBase[Any, T]], tag: ResourceTag[R]): AfterBind = {
      import tag._
  ...
  trait SetDSLBase[T, AfterAdd, AfterMultiAdd] {
    ...
    final def addResource[R <: DIResourceBase[Any, T]](
      function: ProviderMagnet[R with DIResourceBase[Any, T]]
    )(implicit tag: ResourceTag[R], pos: CodePositionMaterializer): AfterAdd = {
      import tag._
    ...
    final def addResource[R0, R <: DIResourceBase[Any, T]](
      function: ProviderMagnet[R0]
    )(implicit adapt: ProviderMagnet[R0] => ProviderMagnet[R with DIResourceBase[Any, T]], tag: ResourceTag[R], pos: CodePositionMaterializer): AfterAdd = {
      import tag._
