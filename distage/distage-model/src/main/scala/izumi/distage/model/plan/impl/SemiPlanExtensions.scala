...
import izumi.distage.model.plan.impl.PlanSyntaxCatsBoilerplate.{CatsMonoid, ResolveImportFSemiPlanPartiallyApplied, resolveImportsImpl1}
...
private[plan] trait SemiPlanExtensions { this: SemiPlan.type =>
  /**
