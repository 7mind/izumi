...
//
//@deprecated("Obsolete", "28/08/2020")
...
//) {
//  protected def parse(args: Array[String]): Either[CLIParser.ParserError, RawAppArgs] = {
//    new CLIParserImpl().parse(args)
//  }
//
//  protected def requiredRoles: Vector[RawRoleParams] = {
//    Vector.empty
//  }
//
