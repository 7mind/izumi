...
class RoleAppBootModule[F[_]: TagK: DefaultModule](
  ...
  make[Boolean].named("distage.roles.reflection").fromImplicit(DebugProperties.`izumi.distage.roles.reflection`.boolValue(default = true))
  make[Boolean].named("distage.roles.logs.json").fromImplicit(DebugProperties.`izumi.distage.roles.logs.json`.boolValue(default = false))
  make[Boolean].named("distage.roles.ignore-mismatched-effect").fromImplicit(DebugProperties.`izumi.distage.roles.ignore-mismatched-effect`.boolValue(default = false))
  make[Boolean].named("distage.roles.activation.ignore-unknown").fromImplicit(DebugProperties.`izumi.distage.roles.activation.ignore-unknown`.boolValue(default = false))
  make[Boolean].named("distage.roles.activation.warn-unset").fromImplicit(DebugProperties.`izumi.distage.roles.activation.warn-unset`.boolValue(default = true))

  make[Boolean].named("distage.roles.always-include-reference-role-configs").fromImplicit(DebugProperties.`distage.roles.always-include-reference-role-configs`.boolValue(true))
  make[Boolean]
    .named("distage.roles.always-include-reference-common-configs").fromImplicit(DebugProperties.`distage.roles.always-include-reference-common-configs`.boolValue(true))
  make[Boolean].named("distage.roles.ignore-all-reference-configs").fromImplicit(DebugProperties.`distage.roles.ignore-all-reference-configs`.boolValue(default = false))
  make[Boolean]
    .named("distage.roles.enable-config-environment-overrides").fromImplicit(DebugProperties.`distage.roles.enable-config-environment-overrides`.boolValue(default = true))
