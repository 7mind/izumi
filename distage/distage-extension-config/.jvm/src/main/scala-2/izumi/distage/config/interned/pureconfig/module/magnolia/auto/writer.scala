package izumi.distage.config.interned.pureconfig.module.magnolia.auto

import pureconfig.generic.{CoproductHint, ProductHint}
import magnolia1.*
import izumi.distage.config.interned.pureconfig.module.magnolia.{ExportedMagnolia, MagnoliaConfigWriter}
