...
private[providers] trait FunctoidConstructorsTemplate { this: distageFunctoid.type =>

  implicit class FunctoidCompanionConstructorOps(private val functoidCompanion: Functoid.type) {
