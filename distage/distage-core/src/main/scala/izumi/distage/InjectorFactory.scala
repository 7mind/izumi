...
trait InjectorFactory {
  ...
  /**
    ...
    *                      They can be used to extend the Injector, e.g. add ability to inject config values
    */
  def apply[F[_]: QuasiIO: TagK: DefaultModule](bootstrapBase: BootstrapContextModule, overrides: BootstrapModule*): Injector[F]
  ...
  /**
    ...
    *                  They can be used to extend the Injector, e.g. add ability to inject config values
    */
  def withBootstrapActivation[F[_]: QuasiIO: TagK: DefaultModule](activation: Activation, overrides: BootstrapModule*): Injector[F]
  ...
  /**
    ...
    *                      They can be used to extend the Injector, e.g. add ability to inject config values
    */
  def withBootstrapActivation[F[_]: QuasiIO: TagK: DefaultModule](
  ...
  def inheritWithDefaultModule[F[_]: QuasiIO: TagK](parent: Locator, defaultModule: Module): Injector[F]
