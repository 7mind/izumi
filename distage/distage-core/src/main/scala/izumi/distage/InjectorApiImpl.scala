...
import izumi.distage.model.definition.{BootstrapContextModule, BootstrapModule}
import izumi.distage.model.reflective.Bootloader


trait InjectorApiImpl extends InjectorApi {
  /**
  ...
  private[InjectorApiImpl] sealed trait InjectorBootstrap {
