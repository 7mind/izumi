...
//import izumi.functional.bio.{Async2, Bifunctorized, Fork2, Primitives2, PrimitivesM2, Temporal2}
...
//  *
//  *  - Adds [[izumi.functional.bio]] bifunctor BIO instances on `monix.bio.IO`
...
//  // BIO instances
//  include(AnyBIOSupportModule.usingDependencies[IO])
...
//
//  make[Scheduler2[IO]].from {
//    implicit T: Timer[UIO] => implicitly[Scheduler2[IO]]
//  }
//
