...
import izumi.functional.bio.{Async2, BlockingIO2, Fork2, Primitives2, PrimitivesLocal2, PrimitivesM2, Temporal2, UnsafeRun2}
...
sealed trait LowPriorityDefaultModulesInstances3 extends LowPriorityDefaultModulesInstances4 {
  ...
  implicit final def fromBIO[
    ...
    DefaultModule(AnyBIOSupportModule.usingImplicits[F])
  }
}
