...
class DefaultBootstrapContext(contextDefinition: AbstractModuleDef) extends AbstractLocator {
...
//      , loggerHook
  ...
  final lazy val defaultBootstrapContextDefinition: AbstractModuleDef = TrivialModuleDef
