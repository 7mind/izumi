...
object InjectorF {
  ...
  def flatMapX[F[_] : DIEffect : TagK, T, T1](injectorF: InjectorF[F, T])(f: Locator => F[InjectorF[F, T1]]): F[InjectorF[F, T1]] = {
  ...
  def pure[F[_]](module: PlannerInput) = new Module[F](module)
