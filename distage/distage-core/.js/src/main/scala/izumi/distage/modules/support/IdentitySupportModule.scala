...
import izumi.distage.model.effect.{QuasiApplicative, QuasiEffect, QuasiEffectRunner}
...
//  addImplicit[QuasiEffectAsync[Identity]] // No QuasiEffectAsync for Identity on JS
}
