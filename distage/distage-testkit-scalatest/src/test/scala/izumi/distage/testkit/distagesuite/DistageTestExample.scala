...
abstract class DistageTestExampleBase[F[_]: TagK: DefaultModules](implicit F: DIEffect[F]) extends DistageSpecScalatest[F] with DistageMemoizeExample[F] {
...
abstract class DistageSleepTest[F[_]: TagK: DefaultModules](implicit F: DIEffect[F]) extends DistageSpecScalatest[F] with DistageMemoizeExample[F] {
  "distage test" should {
    "sleep" in {
...
abstract class OverloadingTest[F[_]: DIEffect: TagK: DefaultModules] extends DistageSpecScalatest[F] with DistageMemoizeExample[F] {
...
abstract class ActivationTest[F[_]: DIEffect: TagK: DefaultModules] extends DistageSpecScalatest[F] with DistageMemoizeExample[F] {
...
abstract class ForcedRootTest[F[_]: DIEffect: TagK: DefaultModules] extends DistageSpecScalatest[F] {
  override protected def config: TestConfig = super
    .config.copy(
