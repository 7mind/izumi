...
lazy val `fundamentals-functoid` = project.in(file("fundamentals/fundamentals-functoid"))
  .dependsOn(
...
lazy val `distage-testkit-scalatest-tools` = project.in(file("distage/distage-testkit-scalatest-tools"))
  .dependsOn(
...
lazy val `microsite` = project.in(file("doc/microsite"))
  .dependsOn(
    ...
    `distage-testkit-scalatest-tools` % "test->compile;compile->compile",
...
lazy val `distage` = (project in file(".agg/distage-distage"))
  ...
  .aggregate(
    ...
    `distage-testkit-scalatest-tools`
  )
