...
lazy val `fundamentals-js` = (project in file("fundamentals/.agg-js"))
  .settings(
    skip in publish := true,
    crossScalaVersions := Seq(
      "2.12.9",
...
lazy val `logstage-js` = (project in file("logstage/.agg-js"))
  .settings(
    skip in publish := true,
    crossScalaVersions := Seq(
      "2.12.9",
...
lazy val `idealingua-js` = (project in file("idealingua-v1/.agg-js"))
  .settings(
    skip in publish := true,
    crossScalaVersions := Seq(
      "2.12.9",
...
lazy val `izumi-js` = (project in file("./.agg-js"))
  .settings(
    skip in publish := true,
    crossScalaVersions := Seq(
      "2.12.9",
