...
lazy val idealinguaModel = inIdealingua.as.module
  .settings(libraryDependencies ++= Seq(R.scala_reflect, R.json4s_native))


lazy val idealinguaCore = inIdealingua.as.module
  .depends(idealinguaModel)
  .settings(libraryDependencies ++= Seq(R.scalameta, R.fastparse) ++ Seq(T.scala_compiler, T.scala_library))
