...
object PrimitivesM2 {
  ...
  implicit final class PrimitivesM2Ops[F[+_, +_]](private val self: PrimitivesM2[F]) extends AnyVal {
    def mapK[G[+_, +_]](fg: F `Isomorphism2` G)(using G: Functor2[G]): PrimitivesM2[G] = new PrimitivesM2[G] {
...
object PrimitivesMInstances extends PrimitivesMLowPriorityInstances1 {
  @inline given PrimitivesZio[F[-_, +_, +_]: `zio.ZIO`]: PrimitivesM2[F[Any, +_, +_]] = PrimitivesMZio.asInstanceOf[PrimitivesM2[F[Any, +_, +_]]]
}

sealed trait PrimitivesMLowPriorityInstances1 extends PrimitivesMLowPriorityInstances2 {
  @inline given PrimitivesZioR[F[-_, +_, +_]: `zio.ZIO`, R]: PrimitivesM2[F[R, +_, +_]] = PrimitivesMZio.asInstanceOf[PrimitivesM2[F[R, +_, +_]]]

}
sealed trait PrimitivesMLowPriorityInstances2 {
  @inline given PrimitivesFromBIO[F[+_, +_]: Bracket2: Primitives2]: PrimitivesM2[F] = new PrimitivesMFromBIO[F]
}
