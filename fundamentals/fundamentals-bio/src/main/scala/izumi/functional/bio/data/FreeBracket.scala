...
sealed trait FreeBracket[S[_, _], +E, +A] {
  ...
  @inline final def bracket[B, E1 >: E](release: A => FreeBracket[S, Nothing, Unit])(use: A => FreeBracket[S, E1, B]): FreeBracket[S, E1, B] =
    FreeBracket.BracketCase(this, (a: A, _: BIOExit[E1, B]) => release(a), use)
  @inline final def bracketCase[B, E1 >: E](release: (A, BIOExit[E1, B]) => FreeBracket[S, Nothing, Unit])(use: A => FreeBracket[S, E1, B]): FreeBracket[S, E1, B] =
    FreeBracket.BracketCase(this, release, use)
  ...
  @inline def foldMap[G[+_, +_]](transform: S ~>> G)(implicit G: BIOPanic[G]): G[E, A] = {
    this match {
      ...
      case FreeBracket.BracketCase(acquire, release, use) =>
...
object FreeBracket {
  ...
  private[data] final case class BracketCase[S[_, _], E, A0, A](
    acquire: FreeBracket[S, E, A0],
    release: (A0, BIOExit[E, A]) => FreeBracket[S, Nothing, Unit],
    use: A0 => FreeBracket[S, E, A],
