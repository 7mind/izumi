...
object Morphism3 {
  ...
  @inline implicit def identity3[F[_, _, _]]: Morphism3[F, F] = this.identity
  @inline implicit def identity2[F[_, _]]: Morphism2[F, F] = this.identity
  @inline implicit def identity1[F[_]]: Morphism1[F, F] = this.identity
