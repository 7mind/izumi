...
trait BIOLocal[FR[-_, +_, +_]] extends BIOMonadAsk[FR] with BIOLocalInstances {
  def provide[R, E, A](fr: FR[R, E, A])(env: => R)(implicit ev: R =!= Any): FR[Any, E, A] = contramap(fr)((_: Any) => env)(null, ev)
  def contramap[R, E, A, R0](fr: FR[R, E, A])(f: R0 => R)(implicit ev1: R0 =!= Any, ev2: R =!= Any): FR[R0, E, A]
}
