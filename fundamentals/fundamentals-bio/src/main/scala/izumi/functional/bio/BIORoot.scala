...
sealed trait BIORootInstancesLowPriority1 extends BIORootInstancesLowPriority2 {
  @inline implicit final def BIOConvertFromBIOMonadAsk[FR[-_, +_, +_]](implicit BIOMonadAsk: NotPredefined.Of[BIOMonadAsk[FR]]): BIOMonad3[FR] with S2 =
    S2(BIOMonadAsk.InnerF)
...
sealed trait BIORootInstancesLowPriority3 extends BIORootInstancesLowPriority4 {
  @inline implicit final def BIOConvertFromBIOAsk[FR[-_, +_, +_]](implicit BIOAsk: NotPredefined.Of[BIOAsk[FR]]): BIOApplicative3[FR] with S4 = S4(BIOAsk.InnerF)
...
sealed trait BIORootInstancesLowPriority4 extends BIORootInstancesLowPriority5 {
  @inline implicit final def BIOConvertFromBIOProfunctor[FR[-_, +_, +_]](implicit BIOProfunctor: NotPredefined.Of[BIOProfunctor[FR]]): BIOFunctor3[FR] with S5 =
    S5(BIOProfunctor.InnerF)
}

sealed trait BIORootInstancesLowPriority5 extends BIORootInstancesLowPriority6 {
  @inline implicit final def BIOConvertFromBIOBifunctor[FR[-_, +_, +_]](implicit BIOBifunctor: NotPredefined.Of[BIOBifunctor3[FR]]): BIOFunctor3[FR] with S6 =
    S6(BIOBifunctor.InnerF)
}
