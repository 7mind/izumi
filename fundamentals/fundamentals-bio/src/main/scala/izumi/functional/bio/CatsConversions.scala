...
trait CatsConversions5 extends CatsConversions6 {
  @inline implicit final def BIOToBracket[F[+_, +_]](implicit F: Panic2[F]): cats.effect.MonadCancel[F[Throwable, ?], Throwable] with S7 = new BIOCatsBracket[F](F)
}
...
object CatsConversions {
  ...
  class BIOCatsBracket[F[+_, +_]](override val F: Panic2[F]) extends BIOCatsMonadError[F, Throwable](F) with cats.effect.MonadCancel[F[Throwable, ?], Throwable] {
