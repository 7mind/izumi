...
object FreeError {
  ...
  @inline implicit def FreeErrorInstances[S[_, _]]: Error2[FreeError[S, +?, +?]] = Error2Instance.asInstanceOf[Error2Instance[S]]

  object Error2Instance extends Error2Instance[Any]
  class Error2Instance[S[_, _]] extends Error2[FreeError[S, +?, +?]] {
