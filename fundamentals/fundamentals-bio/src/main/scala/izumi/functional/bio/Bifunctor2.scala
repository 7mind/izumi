...
trait Bifunctor2[F[+_, +_]] extends RootBifunctor[F] {
  ...
  @inline final def widenError[E, A, E1](r: F[E, A])(using @unused ev: E <:< E1): F[E1, A] = r.asInstanceOf[F[E1, A]]
  @inline final def widenBoth[E, A, E1, A1](r: F[E, A])(using @unused ev: E <:< E1, @unused ev2: A <:< A1): F[E1, A1] =
