...
private[quasi] trait LowPriorityQuasiIORunnerInstances extends LowPriorityQuasiIORunnerInstances1 {
  ...
  given fromCatsDispatcher[F[_], Dispatcher[_[_]]: `cats.effect.std.Dispatcher`](using dispatcher: Dispatcher[F]): QuasiIORunner[F] =
...
private[quasi] trait LowPriorityQuasiIORunnerInstances1 {
  ...
  given fromCatsIORuntime[IO[_]: `cats.effect.IO`, IORuntime: `cats.effect.unsafe.IORuntime`](using ioRuntime: IORuntime): QuasiIORunner[IO] =
