...
/**
  * adapted from Cats Effect [[https://github.com/typelevel/cats-effect/blob/8c15bb9a1e09028345f02d33da445464a65e08d3/std/js/src/main/scala/cats/effect/std/SecureRandomCompanionPlatform.scala]]
  *
...
private[uuid] object __SecureRandomPlatformSpecific {
  ...
  private[uuid] class SecureRandomImpl() extends java.util.Random(0L) {
    ...
    private val getRandomValuesFun = SecureRandomImpl.getRandomValuesFun
  ...
  private[uuid] object SecureRandomImpl {
