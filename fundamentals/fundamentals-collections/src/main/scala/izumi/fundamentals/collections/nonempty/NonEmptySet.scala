...
final class NonEmptySet[T] private (val toSet: Set[T]) extends AnyVal {
  ...
  /**
    * Returns a new <code>NonEmptySet</code> containing the elements of this <code>NonEmptySet</code> followed by the elements of the passed <code>Vector</code>.
    * The element type of the resulting <code>NonEmptySet</code> is the most specific superclass encompassing the element types of this <code>NonEmptySet</code> and the passed <code>Vector</code>.
    *
    * @tparam U the element type of the returned <code>NonEmptySet</code>
    * @param other the <code>Vector</code> to append
    * @return a new <code>NonEmptySet</code> that contains all the elements of this <code>NonEmptySet</code> followed by all elements of <code>other</code>.
    */
  def ++[U >: T](other: Vector[U]): NonEmptySet[U] = new NonEmptySet(toSet ++ other)

  // TODO: Have I added these extra ++, etc. methods to Vector that take a NonEmptySet?
  ...
  def ++(other: IterableOnce[T]): NonEmptySet[T] =
    if (other.iterator.isEmpty) this else new NonEmptySet(toSet ++ other.iterator.to(Set))
  ...
  /**
    ...
    */
  def flatten[B](implicit ev: T <:< NonEmptySet[B]): NonEmptySet[B] = flatMap(ev)
  ...
  /**
    * Checks if the given <code>Vector</code> contains the same elements in the same order as this <code>NonEmptySet</code>.
    *
  ...
  /**
    ...
    *     in the same order, <code>false</code> otherwise.
    */
  def sameElements[U >: T](that: NonEmptySet[U]): Boolean = toSet == that.toSet
  ...
  /**
    ...
    */
  def scan[U >: T](z: U)(op: (U, U) => U): NonEmptySet[U] = new NonEmptySet(toSet.scan(z)(op))
  ...
  /**
    ...
    */
  def scanLeft[B](z: B)(op: (B, T) => B): NonEmptySet[B] = new NonEmptySet(toSet.scanLeft(z)(op))
  ...
  /**
    ...
    */
  def scanRight[B](z: B)(op: (T, B) => B): NonEmptySet[B] = new NonEmptySet(toSet.scanRight(z)(op))
  ...
  /**
    ...
    */
  def sliding(size: Int): Iterator[NonEmptySet[T]] = toSet.sliding(size).map(new NonEmptySet(_))
  ...
  /**
    ...
    *     if there are fewer elements than <code>size</code>.
    */
  def sliding(size: Int, step: Int): Iterator[NonEmptySet[T]] = toSet.sliding(size, step).map(new NonEmptySet(_))
  ...
  def transpose[U](implicit ev: T <:< NonEmptySet[U]): NonEmptySet[NonEmptySet[U]] = {
  ...
  /**
    * Produces a new <code>NonEmptySet</code> that contains all elements of this <code>NonEmptySet</code> and also all elements of a given <code>Vector</code>.
    *
    * <p>
    ...
    * @return a new <code>NonEmptySet</code> that contains all elements of this <code>NonEmptySet</code> followed by all elements of <code>that</code> <code>Vector</code>.
    */
  def union(that: Vector[T]): NonEmptySet[T] = new NonEmptySet(toSet union that.toSet)
  ...
  /**
    ...
    */
  def union(that: NonEmptySet[T]): NonEmptySet[T] = new NonEmptySet(toSet union that.toSet)
  ...
  /**
    ...
    */
  def union(that: Set[T])(implicit dummyImplicit: DummyImplicit): NonEmptySet[T] = new NonEmptySet(toSet.union(that))
  ...
  /**
    ...
    */
  def unzip[L, R](implicit asPair: T => (L, R)): (NonEmptySet[L], NonEmptySet[R]) = {
  ...
  /**
    ...
    */
  def unzip3[L, M, R](implicit asTriple: T => (L, M, R)): (NonEmptySet[L], NonEmptySet[M], NonEmptySet[R]) = {
  ...
  /**
    ...
    */
  def zipAll[O, U >: T](other: collection.Iterable[O], thisElem: U, otherElem: O): NonEmptySet[(U, O)] =
...
object NonEmptySet {
  ...
  /**
    ...
    *
    * @param set the <code>Set</code> with which to construct a <code>NonEmptySet</code>
