...
object DIKey {
  ...
  final case class TypeKey(tpe: SafeType, mutatorIndex: Option[Int] = None) extends BasicKey {
    ...
    override def toString: String = formatWithIndex(s"{type.${tpe.tag.scalaStyledRepr}}", mutatorIndex)
  }
  ...
  final case class IdKey[I: IdContract](tpe: SafeType, id: I, mutatorIndex: Option[Int] = None) extends BasicKey {
    ...
    override def toString: String = formatWithIndex(s"{type.${tpe.tag.scalaStyledRepr}@${idContract.repr(id)}}", mutatorIndex)
  }
