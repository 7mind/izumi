...
class TypespaceConversionCalculator(ts2: Typespace2) extends WarnLogger.WarnLoggerImpl {
...
object TypespaceConversionCalculator {
  ...
  final case class Output(conversions: List[Conversion], warnings: Vector[T2Warn])
