...
final case class ServiceMethodProduct(ctx: STContext, sp: ServiceContext, method: RPCMethod) {
  ...
  protected object Input {
    ...
    def defnDecoder: Defn.Def =
      q"""def decodeRequest[Or[+_, +_] : IRTMicroBIO]: PartialFunction[IRTJsonBody, Or[Nothing, IRTReqBody]] = {
  ...
  protected object Output {
    ...
    def defnDecoder: Defn.Def = {
      q"""def decodeResponse[Or[+_, +_] : IRTMicroBIO]: PartialFunction[IRTJsonBody, Or[Nothing, IRTResBody]] = {
