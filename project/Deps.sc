import $ivy.`io.7mind.izumi.sbt::sbtgen:0.0.60`
  ...
  final lazy val distage = Aggregate(
    ...
    artifacts = Seq(
      ...
      Artifact(
        ...
        depends =
          Seq(Projects.distage.config, Projects.distage.framework, Projects.distage.extensionLogstage).map(_ in Scope.Compile.all) ++
